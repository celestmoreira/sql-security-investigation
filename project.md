...
![Login Attempts on Specfic Dates](screenshots/login_attempts_specific_dates.png)
...
By using this query, I was able to review all login activity surrounding the suspicous event and better understand what occurred before and during that time period. 